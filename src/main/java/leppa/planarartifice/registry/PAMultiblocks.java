...
public class PAMultiblocks{
	...
	public static void registerMultiblocks() {
		...
		mirromerous_teleporter = new BluePrint("MIRRORTELEPORTER", new Part[][][] {{{TP}}, {{MT}}, {{BP}}}, new ItemStack(PABlocks.teleporter_matrix), new ItemStack(BlocksTC.stoneArcaneBrick, 2));
