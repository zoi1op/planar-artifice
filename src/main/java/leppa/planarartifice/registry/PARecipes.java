...
//    	registerPotionMixerRecipes(e);
	...
	private static void registerCrucibleRecipes(Register<IRecipe> e) {
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:glowstone_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.GLOWSTONE_DUST, 2), new ItemStack(Items.GLOWSTONE_DUST), new AspectList().add(Aspect.LIGHT, 20)));
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:lapis_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.DYE, 2, 4), new ItemStack(Items.DYE, 1, 4), new AspectList().add(Aspect.SENSES, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:coal_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.COAL, 2), new ItemStack(Items.COAL), new AspectList().add(Aspect.FIRE, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:quartz_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.QUARTZ, 2), new ItemStack(Items.QUARTZ), new AspectList().add(Aspect.CRYSTAL, 20)));
