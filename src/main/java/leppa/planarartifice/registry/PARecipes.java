...
//    	registerPotionMixerRecipes(e);
	...
	private static void registerCrucibleRecipes(Register<IRecipe> e) {
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:glowstone_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@1", new ItemStack(Items.GLOWSTONE_DUST, 2), new ItemStack(Items.GLOWSTONE_DUST), new AspectList().add(Aspect.LIGHT, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:ender_pearls"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@1", new ItemStack(Items.ENDER_PEARL, 2), new ItemStack(Items.ENDER_PEARL), new AspectList().add(Aspect.ELDRITCH, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:redstone2"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@1", new ItemStack(Items.REDSTONE, 2), new ItemStack(Items.REDSTONE), new AspectList().add(Aspect.ENERGY, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:lapis_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@2", new ItemStack(Items.DYE, 2, 4), new ItemStack(Items.DYE, 1, 4), new AspectList().add(Aspect.SENSES, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:coal_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@2", new ItemStack(Items.COAL, 2), new ItemStack(Items.COAL), new AspectList().add(Aspect.FIRE, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:quartz_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@2", new ItemStack(Items.QUARTZ, 2), new ItemStack(Items.QUARTZ), new AspectList().add(Aspect.CRYSTAL, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:amber_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(ItemsTC.amber, 2), new ItemStack(ItemsTC.amber), new AspectList().add(Aspect.TRAP, 20).add(Aspect.CRYSTAL, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:blaze_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.BLAZE_POWDER, 2), new ItemStack(Items.BLAZE_POWDER), new AspectList().add(Aspect.FIRE, 20).add(Aspect.ALCHEMY, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:chorus_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.CHORUS_FRUIT, 2), new ItemStack(Items.CHORUS_FRUIT), new AspectList().add(Aspect.ELDRITCH, 20).add(Aspect.PLANT, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:slime_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.SLIME_BALL, 2), new ItemStack(Items.SLIME_BALL), new AspectList().add(Aspect.WATER, 20).add(Aspect.LIFE, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bone_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.BONE, 2), new ItemStack(Items.BONE), new AspectList().add(Aspect.DEATH, 20).add(Aspect.LIFE, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:cactus_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Blocks.CACTUS, 2), new ItemStack(Blocks.CACTUS), new AspectList().add(PAAspects.COLOR, 20).add(Aspect.PLANT, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:mushroom_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Blocks.BROWN_MUSHROOM, 2), new ItemStack(Blocks.BROWN_MUSHROOM), new AspectList().add(Aspect.EARTH, 20).add(Aspect.DARKNESS, 20)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:mushroom_conjure2"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Blocks.RED_MUSHROOM, 2), new ItemStack(Blocks.RED_MUSHROOM), new AspectList().add(Aspect.FIRE, 20).add(Aspect.DARKNESS, 20)));
        AspectList gunpowderDupe = new AspectList();
        if (ThaumicAdditionsHandler.extraActivated) gunpowderDupe.add(KnowledgeTAR.EXITIUM, 20).add(Aspect.ENTROPY, 20);
        else gunpowderDupe.add(Aspect.FIRE, 20).add(Aspect.ENTROPY, 20);
...
//            ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:gold_to_lead"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_3", OreUtils.getFirst("ingotLead"), new ItemStack(Items.GOLD_INGOT), metalRevert));
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_iron"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", new ItemStack(Items.IRON_INGOT), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.METAL, 5)));
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_gold"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", new ItemStack(Items.GOLD_INGOT), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.DESIRE, 5)));
        if (OreDictionary.doesOreNameExist("ingotCopper")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_copper"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotCopper"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.EXCHANGE, 5)));
        if (OreDictionary.doesOreNameExist("ingotTin")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_tin"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotTin"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.CRYSTAL, 5)));
        if (OreDictionary.doesOreNameExist("ingotLead")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_lead"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotLead"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.ORDER, 5)));
        if (OreDictionary.doesOreNameExist("ingotSilver")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_silver"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotSilver"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.SOUL, 5)));
        if (OreDictionary.doesOreNameExist("ingotNickel")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_nickel"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotNickel"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.CRAFT, 5)));
        if (OreDictionary.doesOreNameExist("ingotAluminium")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_aluminium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotAluminium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.AIR, 5)));
        if (OreDictionary.doesOreNameExist("ingotArdite")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_ardite"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotArdite"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(PAAspects.DIMENSIONS, 5)));
        if (OreDictionary.doesOreNameExist("ingotCobalt")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_cobalt"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotCobalt"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(PAAspects.TIME, 5)));
        if (OreDictionary.doesOreNameExist("ingotIridium")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_iridium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotIridium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.MECHANISM, 5)));
        if (OreDictionary.doesOreNameExist("ingotPlatinum")) {
            if (ThaumicAdditionsHandler.extraActivated) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_platinum"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotPlatinum"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(KnowledgeTAR.CAELES, 5)));
            else ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_platinum"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotPlatinum"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.MAN, 5)));
        }
        if (OreDictionary.doesOreNameExist("ingotOsmium")) {
            if (ThaumicAdditionsHandler.extraActivated) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_osmium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotOsmium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(KnowledgeTAR.VENTUS, 5)));
            else ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_osmium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotOsmium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.VOID, 5)));
        }
        if (OreDictionary.doesOreNameExist("ingotUranium")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_uranium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotUranium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.DEATH, 5)));
        if (OreDictionary.doesOreNameExist("ingotDraconium")) {
            if (ThaumicAdditionsHandler.extraActivated) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_draconium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotDraconium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(KnowledgeTAR.DRACO, 5)));
            else ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_draconium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotDraconium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.ELDRITCH, 5)));
        }
        if (OreDictionary.doesOreNameExist("ingotMithril")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_mithril"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotMithril"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.MAGIC, 5)));
        if (OreDictionary.doesOreNameExist("ingotTitanium")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_titanium"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotTitanium"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.PROTECT, 5)));
        if (OreDictionary.doesOreNameExist("ingotTungsten")) ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:bismuth_to_tungsten"), new CrucibleRecipe("PA_BUSH_ALCHEMY_METAL_BISMUTH", OreUtils.getFirst("ingotTungsten"), new ItemStack(PAItems.bismuth_ingot), new AspectList().add(Aspect.AVERSION, 5)));
	}
