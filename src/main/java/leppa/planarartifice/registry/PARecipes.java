...
//    	registerPotionMixerRecipes(e);
	...
	private static void registerCrucibleRecipes(Register<IRecipe> e) {
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:sugar_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING@1", new ItemStack(Items.SUGAR, 2), new ItemStack(Items.SUGAR), new AspectList().add(Aspect.AIR, 20)));
        ...
        ThaumcraftApi.addCrucibleRecipe(new ResourceLocation("planarartifice:flesh_conjure"), new CrucibleRecipe("PA_BUSH_ALCHEMY_CONJURING", new ItemStack(Items.ROTTEN_FLESH, 2), new ItemStack(Items.ROTTEN_FLESH), new AspectList().add(Aspect.MAN, 20).add(Aspect.LIFE, 20)));
